...
`lobsters.rss`, `daringfireball.atom`, and `daringfireball.json` are captures of those feeds, the Daring Fireball ones cut to five entries. `broken.rss` is not well-formed.
